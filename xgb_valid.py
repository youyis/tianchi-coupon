...
valid_out['User_id'] = valid_feat_origin['User_id']
valid_out['Merchant_id']  =  valid_feat_origin['Merchant_id']
valid_out['Coupon_id'] =  valid_feat_origin['Coupon_id']
valid_out['Date_received'] =  valid_feat_origin['Date_received']
valid_out['weekr'] = valid_feat_origin['weekr']
valid_out['weekd'] = valid_feat_origin['weekd']
valid_out['distance'] = valid_feat_origin['distance']
valid_out['dis_rate'] = valid_feat_origin['dis_rate']
